"""
Django settings for course_gpt project.
...
def get_bool_conf(key: str, default: bool):
    return os.environ.get(key, default=str(default)).lower() == 'true'
...
DEBUG = get_bool_conf('DEBUG', True)
...
WSGI_APPLICATION = 'course_gpt.wsgi.application'

DATABASES = {
    "default": {
        "ENGINE": os.environ.get("DATABASE_ENGINE", "django.db.backends.postgresql"),
        "NAME": os.environ.get("DATABASE_DATABASE", "course_gpt"),
